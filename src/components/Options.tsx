import { useAppSelector, useAppDispatch, setChartData, setChartYTitle, setChartXTitle, setChartAlgName, setChartAlgProps, resetChart } from "../redux";
import { Alert, Button, FormControl, Grid, InputLabel, LinearProgress, MenuItem, Select, TextField, Typography } from "@mui/material";
        ...
        <Grid container spacing={3}>
            {isLoading ? (
                ...
                <Grid item sm={12}>
                    <Alert
                        severity="success"
                        action={<Button>Download as Image</Button>}
                    >
